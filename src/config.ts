...
class Config {
	...
	get contextMenuActionsVisibility(): ContextMenuActionsVisibility {
		...
		const config: ContextMenuActionsVisibility = {
			...
			commit: { addTag: true, createBranch: true, createWorktree: true, checkout: true, cherrypick: true, revert: true, drop: true, merge: true, rebase: true, reset: true, undo: true, editMessage: true, copyHash: true, copySubject: true, generatePatch: true, interactiveRebaseFromHere: true, push: true },
